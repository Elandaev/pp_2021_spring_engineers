...
TEST(INTEGRAL, Integral_func_4_tbb) {
    ...
    std::vector<double> end = {12};
    double step = 0.001;
    ASSERT_NEAR(0.143955, RecIntTbb(start, end, f4, step), 0.1);
}

TEST(INTEGRAL, Integral_func_4_v2_tbb) {
...
//    std::vector<double> end = {12};
//    double step = 0.0003;
//    ASSERT_NEAR(-18.059156, RecIntTbb(start, end, f5, step), 0.01);
//}
